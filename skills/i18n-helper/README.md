# 🌍 i18n-helper — 多语言国际化助手

Claude Code Skill，识别代码中的硬编码 UI 文本，自动生成 translation key，同步更新 en/zh 语言文件并替换源代码。
...
| plugins | 插件管理 |
| models | 模型服务商、模型选择 |
| ... | 以及 home, menu, shortcuts, user, window, workspaces 等 |
