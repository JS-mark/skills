# 🤖 agent-pipeline — 多 Agent 协作开发流水线

Claude Code Skill，通过 7 个阶段、6 个专业 AI 角色，自动完成从需求分析到测试通过的完整软件开发流程。
...
> 详细安装说明见 [@aspect-mark/agent-pipeline README](../../packages/agent-pipeline/README.zh-CN.md)
